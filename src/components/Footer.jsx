  ...
  return (
    <div className="bg-black p-16 gap-12 flex flex-col md:flex-row justify-between">
      <div className='flex flex-col gap-6'>
        ...
        <p className="max-w-xs opacity-60 text-sm text-justify">We’re on a mission to build secure, smart, and future-ready digital solutions that empower businesses, families, and communities to thrive in a connected world.</p>
      </div>
