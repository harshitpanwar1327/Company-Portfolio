...
import { Code, Menu, Close } from "@mui/icons-material"
...
const Navigation = () => {
  ...
  return (
    <div className="flex items-center gap-4 md:gap-8 py-6 text-white text-lg">
      <NavLink to="/" className="font-semibold flex items-center gap-1 cursor-pointer hover:opacity-70 transition-opacity duration-300 ease-in-out"><Code /> CodeWeave</NavLink>
      ...
      <Menu className="absolute right-5 md:!hidden cursor-pointer" onClick={()=>setOpenNav(true)}/>
