...
const projects = [
    {
        tag: "Web App",
        title: "QweRty — QR Platform",
        webLink: "https://codeweaveqwerty.site/",
        desc: "Built a modern QR generating platform with dynamic QR creation, clean UI, and fast performance. Developed as an in-house CodeWeave product and currently live.",
        image: Images.Project1,
    },
    {
        tag: "ERP SaaS",
        title: "ClassEzo — Education ERP",
        webLink: "/contact",
        desc: "Developing an all-in-one coaching center and school management SaaS platform to streamline student records, fees, attendance, batches, and daily operations for educational institutes.",
        image: Images.Project2,
    },
    {
        tag: "Web App",
        title: "DailySpend — Expense Tracker",
        webLink: "https://dailyspend.in",
        desc: "Built a modern expense tracker web application for Outect with smart expense management features, responsive design, and scalable architecture. Developed in a 50% partnership collaboration.",
...
const Work = () => {
  ...
  return (
    <>
        <Element name='work' className='w-screen min-h-[80vh] lg:min-h-[100vh] px-4 md:px-12 lg:px-20 pb-8 bg-[url(/src/assets/hero.webp)] bg-cover bg-center flex flex-col gap-50'>
            <Navigation />
        ...
        <section className="grid lg:grid-cols-2 gap-8 py-12 lg:py-24 px-4 lg:px-16">
            ...
            <div key={project.title} className="flex flex-col gap-4 rounded-3xl p-4 border border-gray-200 hover:-translate-y-1 hover:shadow-[0_15px_45px_hsl(243_75%_59%/0.15)] transition duration-300 text-black">
                ...
                <div className="flex flex-col gap-4 p-4">
                    ...
                    <a href={project.webLink} target="_blank" rel="noopener noreferrer" aria-label="View project" className="self-end flex items-center bg-white p-1 rounded-full font-semibold hover:bg-gray-200 group transition duration-300">
