...
const Hero = () => {
  return (
    <>
      <div className="fixed top-0 w-screen h-[100vh] px-8 md:px-16 pb-8 bg-[url(/src/assets/hero.jpg)] bg-cover bg-center flex flex-col justify-between gap-16 overflow-y-auto">
        <Navigation />

        <div className="flex flex-col gap-3 text-white">
          <h2 className='text-4xl md:text-5xl md:w-2/3 lg:w-1/2'>Innovating Secure & Smart Digital Solutions</h2>
          <p className="text-lg mb-6 md:w-1/2">From enterprise-grade security to modern web platforms, we craft solutions that power businesses, protect data, and inspire growth.</p>
      ...
      <div className='w-screen bg-white z-10 absolute top-[100vh]'>
        <div className="bg-white py-30 px-4 md:px-12 lg:px-20">
